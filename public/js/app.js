            ...
            (function () {
                ...
                var runInContext = function runInContext(context) {
                    ...
                    function baseIsDate(value) {
                        return (
                            isObjectLike(value) && baseGetTag(value) == dateTag
                        );
                    }
                    ...
                    function baseRandom(lower, upper) {
                        return (
                            lower +
                            nativeFloor(nativeRandom() * (upper - lower + 1))
                        );
                    }
                    ...
                    function spread(func, start) {
                        ...
                        start =
                            start == null ? 0 : nativeMax(toInteger(start), 0);
                        return baseRest(function (args) {
                    ...
                    function isWeakMap(value) {
                        return (
                            isObjectLike(value) && getTag(value) == weakMapTag
                        );
                    }
