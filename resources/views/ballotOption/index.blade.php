...
{{--                    <a href="{{url('dashboard/edit/ballotoption/'.$info->id)}}"><button type="submit"  class="bg-green-600 hover:bg-green-400 text-white font-bold py-1 px-2 border border-blue-500 rounded">Edit</button></a>--}}
{{--                    <a href="{{url('dashboard/delete/ballotoption/'.$info->id)}}"><button type="submit" class="bg-red-600 hover:bg-red-400 text-white font-bold py-1 px-2 border border-red-500 rounded">Delete</button></a>--}}
{{--                </td>--}}
