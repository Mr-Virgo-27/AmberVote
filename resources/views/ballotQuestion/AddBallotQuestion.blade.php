...
<div class="bg-gray-200 w-full py-8 px-2 sm:py-10 sm:px-6  lg:px-2">
    ...
    <div>
        <form class="bg-white w-11/12 shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{route('AddBQ')}}" method="post" >
        @CSRF
            <div class="mb-4">
        ...
        <table class="w-full border ">
            ...
            <tr  class="bg-gray-100 text-center border-b text-sm text-gray-600">
                ...
                <td>
                    <a href="{{route('BO',$question->id)}}" class="bg-blue-500 text-white hover:shadow-lg text-xs font-thin rounded py-1.5 px-4">Option</a>
                </td>
                <td>
                    <a href="{{url('dashboard/Edit/BallotQuestion/'.$question->id)}}" class="bg-green-500 text-white hover:shadow-lg text-xs font-thin rounded py-1.5 px-4">Edit</a>
                </td>
                <td>
                    <a href="{{url('dashboard/Delete/BallotQuestion/'.$question->id)}}" class="bg-red-500 text-white hover:shadow-lg text-xs font-thin rounded py-1.5 px-4">Remove</a>
                </td>
            </tr>
            @empty
                <tr class="bg-gray-100 text-center border-b text-sm text-gray-600">
