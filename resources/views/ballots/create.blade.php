...
<div class="flex items-center justify-center h-screen bg-gray-200">
            ...
            <div class="bg-white shadow-xl rounded-lg w-1/2">
                <ul class="divide-y divide-gray-300">
                  <div>
                    ...
                    <form>
                      <button method="POST" type="submit" formaction="{{ route('storeBallot') }}" class="py-2 px-4 mt-8 bg-green-600 hover:bg-green-400
 text-white rounded-md shadow-xl" name="ballot_type" value="Mulitple Choice">Select</button>
                    ...
                    <form method="POST">
                      <button type="submit" formaction="{{ route('storeBallot') }}" class="py-2 px-4 mt-8 bg-green-600 hover:bg-green-400
